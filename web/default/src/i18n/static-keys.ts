...
export const STATIC_I18N_KEYS = [
  ...
  'More...',
  'Less',
  'AI model selection center',
  'Choose by scenario',
  'Model collections are recommendation presets and do not change billing groups.',
  'All models',
  'Every model enabled for the current pricing view.',
  'Browse all models available on this site.',
  'Coding assistant',
  'Models that work well for code generation and debugging.',
  'Build, review, refactor, and explain code.',
  'Content creation',
  'Strong language models for drafts, rewriting, and ideation.',
  'Write articles, emails, summaries, and creative content.',
  'Study and research',
  'Long-context and reasoning models for deeper analysis.',
  'Read long material, compare evidence, and reason step by step.',
  'Enterprise work',
  'Reliable models for production workflows and team apps.',
  'Use in customer support, internal tools, and business workflows.',
  'Value assistant',
  'Cost-effective models for high-volume daily tasks.',
  'Keep routine usage affordable without losing useful quality.',
  'Chinese assistant',
  'Models with strong Chinese and local-language support.',
  'Chinese writing, translation, customer service, and knowledge work.',
  'Developer mode',
  'Flexible model access for engineers who want manual control.',
  'Choose exactly which models a key can call.',
  'Official vs SDKMAX',
  'SDKMAX price',
  'Save {{percent}}%',
  'Official',
  ...
  '{{count}} models will be allowed by this key.',
  'Leave unselected to allow all models available to your group.',
  'Pricing selection API Key',
